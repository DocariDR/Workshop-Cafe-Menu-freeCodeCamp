...
![freeCodeCamp](https://img.shields.io/badge/freeCodeCamp-Responsive%20Web%20Design-0A0A23?style=for-the-badge&logo=freecodecamp)
...
- **`display: inline-block`** — alignement de deux éléments `<p>` côte à côte sur la même ligne pour obtenir un layout nom/prix, sans recourir à Flexbox ou Grid.
